...
# 🛡️ LISTA DE USUARIOS AUTORIZADOS (Pon aquí tu ID y el de tus socios separados por comas)
USUARIOS_PERMITIDOS = [5615273235,8375789261]  # 👈 REEMPLAZA ESTE NÚMERO POR TU ID REAL
